...
nonlinear_target_path= strrep(model_path, '.mac', '_nonlinear.m');
linear_target_path= strrep(model_path, '.mac', '_linear.m');
command_str= [
    maxima_path, ...
    ' ', ...
    '--batch-string="', ...
    ...
    'writeMATLAB_nonlinear("""' strrep(nonlinear_target_path, '\', '/') '""",sys@f,sys@outputs,sys@f_lin)$', ...
    'writeMATLAB_linear("""' strrep(linear_target_path, '\', '/') '""",sys@f,sys@outputs,sys@f_lin)$', ...
    '"'];
